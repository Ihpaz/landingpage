...
<div class="row pt-2">
    <div class="col-lg-12">
        <div class="card shadow">
            ...
            <div class="card-body">
                <form class="form" role="form" method="post" action="{{route('master.location.country.update', Hashids::encode($country->id))}}" autocomplete="off">
                    @csrf
                    <input name="_method" type="hidden" value="PUT">
                    <div class="form-group row">
                        <label class="col-lg-2 col-form-label text-right"><strong>ISO Code</strong> <label class="text-danger">*</label> :</label>
                        <div class="col-lg-8">
                            <input type="text" value="{{old('code') ?? $country->code}}" class="form-control" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-2 col-form-label text-right font-bold">{{trans('label.name')}} <label class="text-danger">*</label> :</label>
                        <div class="col-lg-8">
                            <input name="name" type="text" value="{{old('name') ?? $country->name}}" class="form-control" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-2 col-form-label text-right font-bold">Alpha 2 <label class="text-danger">*</label> :</label>
                        <div class="col-lg-8">
                            <input name="alpha_2" type="text" value="{{old('alpha_2') ?? $country->alpha_2}}" class="form-control" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-2 col-form-label text-right font-bold">Alpha 3 <label class="text-danger">*</label> :</label>
                        <div class="col-lg-8">
                            <input name="alpha_3" type="text" value="{{old('alpha_3') ?? $country->alpha_3}}" class="form-control" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-2 col-form-label text-right font-bold">Language <label class="text-danger">*</label> :</label>
                        <div class="col-lg-8">
                            <input name="language" type="text" value="{{old('language') ?? $country->language}}" class="form-control" required>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-8">
                            <input name="latitude" type="text" value="{{old('latitude') ?? $country->latitude}}" class="form-control">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-2 col-form-label text-right">Longitude :</label>
                        <div class="col-lg-8">
                            <input name="longitude" type="text" value="{{old('longitude') ?? $country->longitude}}" class="form-control">
                        </div>
                    </div>
                    <div class="form-group row">
...
<script type="text/javascript">
    $("#select-currency").select2().val([@foreach($country->currencies as $currency)"{{$currency->id}}", @endforeach]).change();
</script>
@endpush