...
<div class="row pt-2">
    <div class="col-lg-12">
        <div class="card shadow">
            ...
            <div class="card-body">
                <form class="form" role="form" method="post" action="{{route('master.location.province.store')}}" autocomplete="off" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group row">
                        ...
                        <div class="col-lg-8">
                            <div class="input-group">
                                <select name="country_id" class="select2 form-control d-none" required>
                                    <option></option>
