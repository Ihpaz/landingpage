    ...
    <div class="col-lg-12">
        <div class="card shadow">
            <div class="card-header">
                <h4 class="mb-0 pull-left">List {{trans('location.regency')}}</h4>
                <div class="pull-right">
                    <a href="{{route('master.location.regency.create')}}" class="btn btn-xs btn-secondary"><i class="fa fa-plus"></i> {{trans('common.add')}}</a>
                </div>
            </div>
            <div class="card-body">
...
var datatable = $('#data-table').DataTable({
    ...
    searchDelay: 1000,
    ajax: {
        url: "{{ route('master.datatable.regency') }}",
    },
    columns: [
        ...
        { data: 'name', name: 'name' },
        { data: 'districts', name: 'districts', className: 'DT_whitespace', orderable: false},
