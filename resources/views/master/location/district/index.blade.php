    ...
    <div class="col-lg-12">
        <div class="card shadow">
            <div class="card-header">
                <h4 class="mb-0 pull-left">List {{trans('location.district')}}</h4>
                <div class="pull-right">
                    <a href="{{route('master.location.district.create')}}" class="btn btn-xs btn-secondary"><i class="fa fa-plus"></i> {{trans('common.add')}}</a>
                </div>
            </div>
            <div class="card-body">
...
var datatable = $('#data-table').DataTable({
    ...
    searchDelay: 1000,
    ajax: {
        url: "{{ route('master.datatable.district') }}",
    },
    columns: [
        ...
        { data: 'name', name: 'name' },
        { data: 'villages', name: 'villages', className: 'DT_whitespace', orderable: false},
