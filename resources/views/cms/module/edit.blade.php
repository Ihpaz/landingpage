...
<div class="row">
    <div class="col-lg-12">
        <div class="card shadow">
            ...
            <div class="card-body">
                <form class="form" role="form" method="post" action="{{route('cms.module.update', Hashids::encode($module->id))}}" autocomplete="off">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-8">
                            <input name="name" type="text" value="{{old('name') ?? $module->name}}" class="form-control" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-8">
                            <select id="i-table" name="table" class="select2 form-control">
                                ...
                                <option value="{{$data->tablename}}" {{$module->table == $data->tablename ? 'selected' : ''}}>{{$data->tablename}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-8">
                            <div class="input-group">
                                ...
                                <input name="model" type="text" value="{{old('model') ?? $module->model}}" class="form-control" required>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
