...
<div class="row pt-2">
    <div class="col-lg-12">
        <div class="card shadow">
            ...
            <div class="card-body">
                <form class="form" role="form" method="post" action="{{route('cms.role.store')}}" autocomplete="off">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-4">
                            <input name="level" type="number" value="{{old('level')}}" class="form-control" min="1" max="9" required>
                                            ...
                                            <ul class="mb-0" style="column-count: 2;column-gap: 0;list-style: none;padding-inline-start:0px;">
                                                <li>
                                                    ...
                                                    <div class="col-lg-12 pl-0 pb-2" style="display:inline-block">
                                                        ...
                                                        <div class="i-checks">
                                                            <input type="checkbox" id="permission-{{$action->name}}" name="{{$action->name}}">
