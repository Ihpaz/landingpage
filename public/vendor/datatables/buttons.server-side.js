(function ($, DataTable) {
    ...
    DataTable.ext.buttons.excel = {
        ...
        text: function (dt) {
            return '<i class="fa fa-download"></i> ' + dt.i18n('buttons.excel', 'Export');
        },
    ...
    DataTable.ext.buttons.attachment = {
        className: 'buttons-excel',

        text: function (dt) {
            return '<i class="fa fa-download"></i> ' + dt.i18n('buttons.excel', 'Download Attachment');
        },

        action: function (e, dt, button, config) {
            var url = _buildUrl(dt, 'attachment');
            window.location = url;
        }
    }
    ...
    DataTable.ext.buttons.postExcelVisibleColumns = {
        ...
        text: function (dt) {
            return '<i class="fa fa-download"></i> ' + dt.i18n('buttons.excel', 'Excel (only visible columns)');
        },
    ...
    DataTable.ext.buttons.csv = {
        ...
        text: function (dt) {
            return '<i class="fa fa-download"></i> ' + dt.i18n('buttons.csv', 'CSV');
        },
    ...
    DataTable.ext.buttons.postCsvVisibleColumns = {
        ...
        text: function (dt) {
            return '<i class="fa fa-download"></i> ' + dt.i18n('buttons.csv', 'CSV (only visible columns)');
        },
